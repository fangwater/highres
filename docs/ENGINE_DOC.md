...
- `stg`: strategy selector: `pairmm`, `sampling`, `sampling_v5`, `sampling_v6`.
...
### 8.2 `sampling` (`src/stgs/sampling.rs`)
...
### 8.3 `sampling_v5` (`src/stgs/sampling_v5.rs`)
...
### 8.4 `sampling_v6` (`src/stgs/sampling_v6.rs`)
