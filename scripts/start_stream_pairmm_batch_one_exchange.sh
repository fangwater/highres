...
IPC_PREFIX="/tmp/mth_pubs/binance-futures-binance-futures"
CONFIG_PATH="${BASE_DIR}/config_one_exchange.toml"
HIGHRES_CONFIG_PATH="${BASE_DIR}/highres_one_exchange.toml"
